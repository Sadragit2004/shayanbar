...
from .models import Meta_tag_model_group,faq,Group_blog, Author, Blog,Lable_blog,Comment,Meta_tag_model
...
class AdminFaqInline(admin.TabularInline):
...
class BlogAdmin(admin.ModelAdmin):
    ...
    inlines = [LableBlogInline,BlogMetaAdminInlin,AdminFaqInline]
